...
export default function ArtworkCard({
  title, meta, imageSrc, href = "#", chip, className,
  priceUsd, addLabel = "Agregar", onAdd,
}: ArtworkCardProps) {
  return (
    <div className={clsx(
      ...
      <a href={href} className="block focus:outline-none focus:ring-2 focus:ring-black/10">
        <div className="relative aspect-[4/3]">
          <Image src={imageSrc} alt={title} fill className="object-cover transition group-hover:scale-[1.02]" sizes="(max-width:768px) 100vw, 33vw" />
          {chip && (
